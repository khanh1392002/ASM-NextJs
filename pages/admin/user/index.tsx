...
const listProducts = (props: Props) => {
  const {data,error,mutate,removeusers} = userpertion()
        ...
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
           <div className="border-4 border-dashed border-gray-200 rounded-lg h-[100%]">
               <div className="max-w-6xl mx-auto py-5 px-4 sm:px-5 lg:px-7">
                   ...
                   <p className='rounded-lg p-2 text-center text-white bg-red-600  w-[100px] mb-5 hover hover:bg-orange-500'><Link  href={`/admin/user/add`}>ADD</Link></p>
